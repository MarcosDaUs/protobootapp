...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido Marcos! Esta aplicación ayuda a elevar números a sus potencias y cuenta con otras características. para aprender de CI y CD");
    }    
